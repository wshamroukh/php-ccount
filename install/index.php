...
if ( pj_POST('action') == 'save' )
{
	...
	{
		$ccount_settings['click_url'] = ((isset($_SERVER['HTTPS']) && strtolower($_SERVER['HTTPS']) == 'on') ? 'https://' : 'http://') . $_SERVER['HTTP_HOST'] . str_replace('/install/index.php', '/click.php', $_SERVER['REQUEST_URI']);
	}
